...
function applySettings(settings) {
  state.lockedCategory = settings.lockedCategory ?? state.lockedCategory;
  state.lockedDifficulty = settings.lockedDifficulty ?? state.lockedDifficulty;
...
function isCurrentEpoch(epoch) {
  return state.operationEpoch === epoch;
}
